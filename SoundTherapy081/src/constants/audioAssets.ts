...
export const AUDIO_MANIFEST = [ 
  ...
  { id: 'bg_western_church_forest_echo', filename: 'bg_church_forest_echo.webp', category: 'scene_backgrounds', title: '西方教会森林回响', description: '场景背景图', size: 180000 },
]; 
...
export const ASSET_LIST = [
  ...
  { id: 'bg_western_church_forest_echo', expectedSize: 180000 },
];
